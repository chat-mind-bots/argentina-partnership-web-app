				...
				<div className={styles.formWrapper}>
					...
					<div>
						...
						<div className={styles.stepDescription}>
							...
							<div>
								Пройдя по Cerrito, вы заметите характерные архитектурные детали
								и стильное оформление кафе. Окна заведения украшены витражами в
								тематике танго, а фасад украшен яркой мозаикой, напоминающей о
								богатой культурной истории страны.
							</div>
						</div>
					</div>
				</div>
